...
export const tutorials: Tutorial[] = [
  ...
  { id: 'run', title: 'Let Shelby try it', target: 'run', trigger: 'new-game', steps: ['Fill in the blank in the script, then press Run (or Cmd/Ctrl + Enter).', 'Run tests your script on this one patron. Try as often as you like; it costs nothing.'] },
  ...
  { id: 'queue', title: 'The other patrons', target: 'queue', trigger: 'run-pass', steps: ['Serve Queue runs your same script for several patrons, each with different values.', 'All of them must pass. Click a failed patron to see their values and result.'] },
  ...
  { id: 'almanac', title: 'Notes in the margin', target: 'almanac', trigger: 'complete', steps: ['The Almanac lists every Python tool you have learned, with a short example each.', 'You can replay any of these tips from there.'] },
  ...
  { id: 'scratch', title: 'The blotting paper', target: 'scratch', trigger: 'scratch', steps: ['Try a short line of Python here using this patron’s names.', 'Scratch work never changes your script.'] },
  ...
  { id: 'replay', title: 'Watch the work', target: 'replay', trigger: 'run', steps: ['Pause, step or scrub through what Shelby just did.', 'Speed only changes the animation, never the answer.'] },
